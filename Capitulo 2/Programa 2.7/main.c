#include <stdio.h>
/* ventas desendentes
El Programa, al recibir como datos tres valores que reprecentan las ventas de los vendedores de una tienda de discos, escribe las ventas en orden descendente.
