...
/* SPa.
El programa, al recibir como datos el tipo de tratamiento, la edad y el numero de dias de internacion de un cliente en un spa, calcula el costo total del trtamiento
...
void main (void)
{
    ...
    if (COS != -1)
    {
        ...
        printf("\nLa clave del tratamiento en incorrecto");
}
