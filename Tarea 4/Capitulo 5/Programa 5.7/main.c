...
El programa, al recibir como dato un arreglo unidimencional desordenado de N elementos, obtiene como salida ese mismo arreglo pero si los elementos repetidos. */
...
void main(void)
{
    ...
    /*LA funcion Imprime se utiliza para escribir un arreglo unidimencional,sin repeticiones, de T elementos de tipo entero. */
    {
        int I;
        for (I=0; I<T; I++)
            printf("\nA[%d]: %d", I, A[I]);
