...
El programa, al recibir como datos las calificaciones de un grupo de 50 alimnos, obtiene la frecuencia de cada una de las calificaciones y ademas escribe cual es la frecuencia mas alta. */
...
void main (void)
{
    int CAL[TAM], FRE[6] = {0};          /* Declaracion de lpos arreglos. */
...
/* La funcion Imprecion se utiliza para imprimir el arreglo de Frecuencias. */
{
    int I;
    for (I=0; I<T; I++)
        printf("\nVEC[%d]: %d", I, VEC[I]);
...
/*Esta funcion obtiene la primera ocurrecia de la frecuencia mas alta. */
{
