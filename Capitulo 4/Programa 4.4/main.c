...
/* Prueba de variables globales, locales y estadisticas.
...
void main (void)
{
    ...
    for (I = 1; I <= 3; I++)
    {
        ...
        printf("\nEl resultado de la funciopn f4 es: %d", f4());
    }
}
int f1 (void)
...
int f2(void)
/* La fencion f2 utiliza la variable local. */
{
    int K = 1;
    K++;
    return (K);
...
{
    int K = 5;
    K = K + K;      /* Uso de la variable local (K) y global (KP) */
    return (K);
}
